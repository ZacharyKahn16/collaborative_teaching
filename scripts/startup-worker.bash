#!/usr/bin/env bash
# Installs all the dependencies required to build a Worker
# Copies the code for Worker from our file storage
# Builds the code using Node.js
# Starts up a Node.js server and attaches it to the Worker process
